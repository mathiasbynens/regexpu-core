...
const unicodeSetFixtures = [
	...
	},
	{
		...
		flags: 'v',
		options: { "unicodeFlag": "transform" },
		throws: /The "v" flag is only supported when the \.unicodeSet option is enabled/
	}
];
